...
Shader "Shader Forge/Glass" {
    Properties {
        ...
        _EffectIntesity ("Effect Intesity", Range(0, 1)) = 0
...
////// Specular:
                ...
                float3 diffuseColor = ((1.0 - lerp(0.0,EffectTexture,node_6070))+lerp(_Color_var.rgb,_ColorEffect_var.rgb,node_6070)); // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float4 _Color_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Color );
                float4 _ColorEffect_var = UNITY_ACCESS_INSTANCED_PROP( Props, _ColorEffect );
                float3 diffColor = ((1.0 - lerp(0.0,EffectTexture,node_6070))+lerp(_Color_var.rgb,_ColorEffect_var.rgb,node_6070));
                float specularMonochrome;
                float3 specColor;
                float _Metallic_var = UNITY_ACCESS_INSTANCED_PROP( Props, _Metallic );
